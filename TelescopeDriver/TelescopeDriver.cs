// ASCOM Telescope driver for myTelescope
//
// Description:	 Telescope driver for Telescope Control System .Implements pulseguiding for autoguiding using a PC. 
//
// Implements:	ASCOM Telescope interface version: 0.1
// Author:	   Ioannis Tsioufis  <iotsioufis@gmail.com>
//
...
namespace ASCOM.myTelescope.Telescope
{
    ...
    //
    // Your driver's DeviceID is ASCOM.myTelescope.Telescope
    //
    // The COM Guid attribute sets the CLSID for ASCOM.myTelescope.Telescope
    // The COM ClassInterface/None attribute prevents an empty interface called _myTelescope from being created and used as the [default] interface
    //
    ...
    [ComVisible(true)]
    [Guid("e87efca6-4398-47d9-b500-cdd6f9192072")]
    [ProgId("ASCOM.myTelescope.Telescope")]
    [ServedClassName("ASCOM Telescope Driver for myTelescope")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="myTelescope"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Telescope()
        {
            try
            {
                ...
                tl = new TraceLogger("", "myTelescope.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.myTelescope.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
            ...
            set
            {
                try
                {
                    ...
                    if (value)
                    {
                        ...
                        serialPort.PortName = TelescopeHardware.comPort;
